...
public class MySqlOffsetContext implements OffsetContext {
    ...
    /**
     * Get the Kafka Connect detail about the source "partition", which describes the portion of the
     * source that we are consuming. Since we're reading the binary log for a single database, the
     * source partition specifies the {@link #setServerName(String) database server}.
     *
     * <p>The resulting map is mutable for efficiency reasons (this information rarely changes), but
     ...
     * the row.
     *
     * <p>This method should always be called before {@link #struct()}.
     *
