...
/** Copy from org.apache.iceberg.flink.FlinkTypeToType adapt Flink cdc type. */
class FlinkCdcTypeToType extends DataTypeDefaultVisitor<Type> {
    ...
    FlinkCdcTypeToType(RowType root) {
        this.root = root;
