...
package org.apache.iceberg.flink.conf;
 ...
 */
public class FlinkMultiWriteConf {
    ...
    public Integer writeParallelism() {
        return confParser
                .intConf()
                .option(FlinkWriteOptions.WRITE_PARALLELISM.key())
                .parseOptional();
    }

    /**
     * NOTE: This may be removed or changed in a future release. This value specifies the interval
     * for refreshing the table instances in sink writer subtasks. If not specified then the default
